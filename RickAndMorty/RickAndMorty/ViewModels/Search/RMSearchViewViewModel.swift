...
final class RMSearchViewViewModel {
    ...
    let configuration: RMSearchViewController.Configuration
    private var optionMapUpdateBlock: (((RMSearchInputViewViewModel.DynamicOption, String)) -> Void)?
    private var searchResultHandler: ((RMSearchResultViewModel) -> Void)?
    private var noResultsHandler: (() -> Void)?
    private var searchResultModel: Codable?
    
    init(configuration: RMSearchViewController.Configuration) {
    ...
    public func executeSearch() {
        ...
        let request = RMRequest(endpoint: configuration.type.endpoint, queryParameters: queryParams)

        switch configuration.type.endpoint {
        case .character:
